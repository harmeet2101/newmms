 ...
 */
public class BusinessPayrollTaxes implements Serializable,Validatable {
    private static final String TAG = BusinessPayrollTaxes.class.getSimpleName();
    ...
    public BusinessPayrollTaxes(){}


    public BusinessPayrollTaxes(Double amount,Double amountMtd,Double amountYtd,String name)
    {
        this.amount=amount;
