 ...
 */
public class PersonalDeductions implements Serializable, Validatable {

    private static final String TAG = PersonalDeductions.class.getSimpleName();
    ...
    public PersonalDeductions(){}


    public PersonalDeductions(Double amount,Double amountMtd,Double amountYtd,String name)
    {
        this.amount=amount;
