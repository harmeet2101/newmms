 ...
 */
public class BusinessExpenses implements Serializable,Validatable {
    private static final String TAG = BusinessExpenses.class.getSimpleName();
    ...
    public BusinessExpenses(Double amount,Double amountMtd,Double amountYtd,String name)
    {
        this.amount=amount;
