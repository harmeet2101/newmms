 ...
 */
public class PersonPayrollTaxes implements Serializable,Validatable {
    private static final String TAG = PersonPayrollTaxes.class.getSimpleName();
    ...
    public PersonPayrollTaxes(){}


    public PersonPayrollTaxes(Double amount,Double amountMtd,Double amountYtd,String name)
    {
        this.amount=amount;
