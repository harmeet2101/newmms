 ...
 */
public class PersonPayCheckAmount implements Serializable, Validatable {

    private static final String TAG = PersonPayCheckAmount.class.getSimpleName();
    ...
    public PersonPayCheckAmount(){}


    public PersonPayCheckAmount(Double amount,Double amountMtd,Double amountYtd,String name)
    {
        this.amount=amount;
