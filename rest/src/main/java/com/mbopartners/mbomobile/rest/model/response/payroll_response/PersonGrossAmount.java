 ...
 */
public class PersonGrossAmount implements Serializable, Validatable {

    private static final String TAG = PayrollAmount.class.getSimpleName();
    ...
    public PersonGrossAmount(){}


    public PersonGrossAmount(Double amount,Double amountMtd,Double amountYtd,String name)
    {
        this.amount=amount;
